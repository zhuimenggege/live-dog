<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="historyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="直播时长" align="center" prop="duration" width="200">
        <template #default="scope">
          <span>{{ scope.row.duration ? `${scope.row.duration}h` : scope.row.duration }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="historyRef" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="主播名称" prop="liveId">
          <el-select :disabled="form.id != null" v-model="form.liveId" placeholder="请选择主播" clearable
            style="width: 200px">
            <el-option v-for="room in roomList" :key="room.liveId" :label="room.anchor" :value="room.liveId" />
          </el-select>
        </el-form-item>
        <el-form-item label="开播时间" prop="startTime">
          <el-date-picker v-model="form.startTime" type="datetime" placeholder="请选择开播时间" style="width: 100%" />
        </el-form-item>
        <el-form-item label="下播时间" prop="endTime">
          <el-date-picker v-model="form.endTime" type="datetime" placeholder="请选择下播时间" style="width: 100%" />
        </el-form-item>
      </el-form>
      <template #footer>
