   ...
   <div class="app-container">
      <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
         <el-form-item label="字典类型" prop="dictType">
            <el-select v-model="queryParams.dictType" style="width: 160px">
               <el-option v-for="item in typeOptions" :key="item.dictId" :label="item.dictName"
                  :value="item.dictType" />
            </el-select>
         </el-form-item>
         <el-form-item label="字典标签" prop="dictLabel">
            <el-input v-model="queryParams.dictLabel" placeholder="请输入字典标签" clearable style="width: 160px"
               @keyup.enter="handleQuery" />
         </el-form-item>
         <el-form-item label="字典键值" prop="dictValue">
            <el-input v-model="queryParams.dictValue" placeholder="请输入字典键值" clearable style="width: 160px"
               @keyup.enter="handleQuery" />
         </el-form-item>
      ...
      <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
         ...
         <el-table-column label="字典类型" align="center" prop="dictType" width="200" />
...
import { optionselect as getDictOptionselect, getType } from "@/api/system/dict_type";
import { listData, getData, delData, addData, updateData } from "@/api/system/dict_data";
...
function getTypeList() {
   getDictOptionselect().then(response => {
      typeOptions.value = response.data.dictType;
   });
}
/** 查询字典数据列表 */
function getList() {
